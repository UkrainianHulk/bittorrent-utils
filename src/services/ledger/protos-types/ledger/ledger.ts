...
import type { ChannelsClient as _ledger_ChannelsClient, ChannelsDefinition as _ledger_ChannelsDefinition } from './ledger/Channels';
...
export interface ProtoGrpcType {
  ...
  ledger: {
    ...
    Channels: SubtypeConstructor<typeof grpc.Client, _ledger_ChannelsClient> & { service: _ledger_ChannelsDefinition }
