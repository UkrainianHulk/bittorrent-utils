...
module.exports = {  
    ...
    AUTOREMOVE_SIZE_QUOTA_PER_DRIVE_GB:  ENV.AUTOREMOVE_SIZE_QUOTA_PER_DRIVE_GB           ? parseInt(ENV.AUTOREMOVE_SIZE_QUOTA_PER_DRIVE_GB)               : 128,
    ...
    AUTOCONFIG_SETTINGS: {     
        max_active_torrent:              ENV.AUTOCONFIG_SETTINGS_MAX_ACTIVE_TORRENT       ? parseInt(ENV.AUTOCONFIG_SETTINGS_MAX_ACTIVE_TORRENT)           : 15,
